...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create quality-control-2400
  fly apps create quality-control-2400-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app quality-control-2400
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app quality-control-2400-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'quality-control-2400-staging' does not match app name in config file 'quality-control-2400'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name quality-control-2400-db
  fly postgres attach --app quality-control-2400 quality-control-2400-db

  fly postgres create --name quality-control-2400-staging-db
  fly postgres attach --app quality-control-2400-staging quality-control-2400-staging-db
  ```
